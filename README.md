...
This repository contains a curated set of applied machine learning classification projects completed using real-world datasets from Kaggle. The projects emphasize end-to-end workflows, including data preprocessing, feature engineering, model selection, and evaluation using domain-appropriate metrics.
...
## Evaluation Metrics
Model performance was evaluated using metrics appropriate to each problem domain, including:
- Accuracy
- Precision & Recall
- F1-score
- AUC–ROC
